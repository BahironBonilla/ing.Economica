...
function validar() {
    ...
    if (tiempo.value && interes.value && inicial.value && !final.value) {
        p.innerHTML = "Tiempo(n): "+tiempo.value+" | Intereses(i): "+interes.value+" | Monto inicial(P): "+inicial.value+"<br><br>"+"El monto final de este problema es: $"+calcularValorFuturo(inicial.value, interes.value, tiempo.value);
    }
    if (tiempo.value && interes.value && !inicial.value && final.value) {
        p.innerHTML = "Tiempo(n): "+tiempo.value+" | Intereses(i): "+interes.value+" | Monto final(F): "+final.value+"<br><br>"+"El monto inicial de este problema es: $"+calcularValorPresente(final.value, interes.value, tiempo.value);
    }
    if (tiempo.value && !interes.value && inicial.value && final.value) {
        p.innerHTML = "Tiempo(n): "+tiempo.value+" | Monto inicial(P): "+inicial.value+" | Monto final(F): "+final.value+"<br><br>"+"El interes de este problema es: "+calcularInteres(final.value, inicial.value, tiempo.value)+"%";
    }
    if (!tiempo.value && interes.value && inicial.value && final.value) {
    ...
    if (tiempo.value && interes.value && inicial.value && final.value) {
        p.innerHTML = "Tiempo(n): "+tiempo.value+" | Intereses(i): "+interes.value+" | Monto inicial(P): "+inicial.value+"Monto final(F): "+final.value+"<br><br>No necesitas calcular nada";
    }
